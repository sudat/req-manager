...
export const systemFunctions: SystemFunction[] = [
  ...
  },
  {
    ...
    category: "screen",
    title: "与信管理画面",
    summary: "与信管理画面：顧客別の与信枠を管理し、限度超過時のアラートを行う",
    status: "implementing",
  ...
  },
  {
    ...
    category: "interface",
    title: "電子請求書送信IF",
    summary: "電子請求書送信IF：電子請求書を顧客ポータルへ送信する",
    status: "not_implemented",
    relatedTaskIds: ["TASK-003"],
  ...
  },
  {
    ...
    category: "internal",
    title: "延滞債権アラート機能",
    summary: "延滞債権アラート機能：延滞債権を検知し、関係者へ通知する",
    status: "testing",
  ...
  // AP関連（8件）
  {
    ...
    category: "screen",
    title: "支払依頼画面",
    summary: "支払依頼画面：支払対象の選択、金額確認、承認依頼を行う",
    status: "implemented",
  ...
  },
  {
    ...
    category: "screen",
    title: "支払承認画面",
    summary: "支払承認画面：支払依頼の一覧表示、承認却下を行う",
    status: "testing",
  ...
  },
  {
    ...
    category: "internal",
    title: "支払実行機能",
    summary: "支払実行機能：承認済支払データを銀行IFへ送信し、支払を実行する",
    status: "implementing",
  ...
  },
  {
    ...
    category: "screen",
    title: "手形管理画面",
    summary: "手形管理画面：支払手形の発行、期日管理、支払処理を行う",
    status: "not_implemented",
  ...
  },
  {
    ...
    category: "internal",
    title: "仕入請求書取込機能",
    summary: "仕入請求書取込機能：仕入先から受け取った請求書データを取り込む",
    status: "implemented",
  ...
  },
  {
    ...
    category: "screen",
    title: "買掛残高確認画面",
    summary: "買掛残高確認画面：仕入先別の買掛残高を表示し、支払計画を策定する",
    status: "testing",
  ...
  },
  {
    ...
    category: "interface",
    title: "仕入先ポータルIF",
    summary: "仕入先ポータルIF：仕入先ポータルと連携し、請求書データを取得する",
    status: "not_implemented",
  ...
  },
  {
    ...
    category: "internal",
    title: "支払予定表作成機能",
    summary: "支払予定表作成機能：買掛データから支払予定を自動作成する",
    status: "implementing",
    relatedTaskIds: ["TASK-013"],
  ...
  // GL関連（8件）
  {
    ...
    category: "screen",
    title: "手動仕訳入力画面",
    summary: "手動仕訳入力画面：手動で仕訳データを入力し、仕訳帳へ登録する",
    status: "implemented",
  ...
  },
  {
    ...
    category: "internal",
    title: "仕訳転記機能",
    summary: "仕訳転記機能：各業務プロセスから自動生成される仕訳を転記する",
    status: "implemented",
  ...
  },
  {
    ...
    category: "screen",
    title: "総勘定元帳画面",
    summary: "総勘定元帳画面：勘定科目別の取引明細を表示する",
    status: "implemented",
  ...
  },
  {
    ...
    category: "screen",
    title: "試算表画面",
    summary: "試算表画面：試算表を表示し、貸借整合を確認する",
    status: "testing",
  ...
  },
  {
    ...
    category: "screen",
    title: "財務諸表画面",
    summary: "財務諸表画面：B/S、P/Lを表示し、Excel出力を行う",
    status: "implementing",
  ...
  },
  {
    ...
    category: "internal",
    title: "決算整理機能",
    summary: "決算整理機能：決算時に必要な整理仕訳を自動計上する",
    status: "not_implemented",
  ...
  },
  {
    ...
    category: "internal",
    title: "固定資産償却機能",
    summary: "固定資産償却機能：固定資産の償却費を自動計算する",
    status: "testing",
  ...
  },
  {
    ...
    category: "screen",
    title: "税申告画面",
    summary: "税申告画面：消費税、法人税の申告データを作成する",
    status: "not_implemented",
