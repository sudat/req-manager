...
## 目的
`/system/[id]/[srfId]/edit` ページのレイアウト修正:
...
| ファイル | 変更内容 |
|----------|----------|
| `app/(with-sidebar)/system/[id]/[srfId]/edit/page.tsx` | 順序変更 + `space-y-4` wrapper追加 |
| `app/(with-sidebar)/system/[id]/[srfId]/edit/components/BasicInfoSection.tsx` | `mb-4` 削除 |
...
1. `http://localhost:3000/system/GL/SRF-027/edit` にアクセス
2. 以下を確認:
