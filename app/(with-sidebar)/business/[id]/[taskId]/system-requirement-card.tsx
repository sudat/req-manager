...
export function SystemRequirementCard({
  ...
  return (
    ...
    >
      <CollapsibleTrigger className="flex flex-wrap items-start justify-between gap-2 mb-3 w-full text-left hover:bg-white/50 rounded px-2 -mx-2 py-1 transition-colors cursor-pointer">
        ...
        <div className="flex items-center gap-2">
          <Badge variant="outline" className="border-blue-200/60 bg-blue-50 text-blue-700 text-[12px] font-medium px-2.5 py-1">
            システム要件
          </Badge>
      ...
      <div className="border-t border-slate-100 pt-3 space-y-2">
        ...
        <Badge variant="outline" className="border-slate-200 bg-slate-50 text-slate-600 text-[12px] px-2.5 py-1">
          ...
          <div className="ml-1 pl-3 border-l-2 border-purple-200">
            ...
            >
              <div className="flex items-center gap-2">
                <Badge
                  variant="outline"
                  className="border-purple-200/60 bg-purple-50 text-purple-700 text-[12px] font-medium px-2.5 py-1"
                >
                  {srf.id}
                </Badge>
